#!/bin/bash
#SBATCH --job-name=yolov8n_predict_test
...
echo "Starting YOLOv8n prediction on SH17 test set"
...
yolo detect predict \
    ...
    name=yolov8n_test_preds

echo "Prediction finished for YOLOv8n on SH17 test set"