#!/bin/bash
#SBATCH --job-name=yolov5m_predict_test
...
echo "Starting YOLOv5m prediction on SH17 test set"
...
python detect.py \
    ...
    --name yolov5m_test_preds

echo "Prediction finished for YOLOv5m on SH17 test set"
